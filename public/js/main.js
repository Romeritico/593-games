    ...
    if (!juegos || juegos.length === 0) {
      ...
      grid.innerHTML = `
        <div class="no-juegos" style="grid-column: 1 / -1; text-align: center; padding: 60px 20px;">
          ...
          <h3 style="color: #2d3436; font-family: 'Poppins', sans-serif; font-size: 1.5rem; margin-bottom: 10px;">
            ¡Pronto tendremos juegos disponibles!
          </h3>
          <p style="color: #636e72; font-family: 'Inter', sans-serif; font-size: 1rem; max-width: 500px; margin: 0 auto;">
            En nuestro canal de YouTube: 
            <a href="https://www.youtube.com/@SUPERBINGOEC" 
               target="_blank" 
               rel="noopener noreferrer"
               style="color: #ff0000; text-decoration: none; font-weight: 600;">
              @SUPERBINGOEC
            </a> 
            puedes ver la transmisión en vivo de nuestros juegos
          </p>
        </div>
      `;
      return;
